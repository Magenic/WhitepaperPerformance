...
namespace Xamarin.IncidentApp.Droid.MvxMaterial
{
        ...
        : MvxBaseFragmentAdapter
    {
        ...
        protected override void HandleDestroyViewCalled(object sender, System.EventArgs e)
        {
        ...
        protected override void HandleDisposeCalled(object sender, System.EventArgs e)
        {
            if (FragmentView.BindingContext != null)
            {
                FragmentView.BindingContext.ClearAllBindings();
